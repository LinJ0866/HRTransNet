...
def get_loader(image_root, dataset_name, batchsize, trainsize, mode='train', shuffle=True, num_workers=0, pin_memory=True):
    dataset = SalObjDataset(image_root, dataset_name, trainsize, mode)
    # print(image_root)
    # print(gt_root)
    # print(depth_root)
